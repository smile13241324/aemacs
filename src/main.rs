...
async fn main() -> Result<()> {
    ...
    if args.iter().any(|arg| arg == "--server") {
        ...
        let registry = Arc::new(ToolRegistry::with_core_tools(kb.clone(), persona_registry.clone(), Some(bus.tx.clone())));
